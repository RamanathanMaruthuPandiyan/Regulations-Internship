...
const BatchJobFilter = ({ getTableData, entities, actions }) => {
                                        ...
                                        <div className="accordion-item border border-0">
                                            <div className="accordion-header">
                                                <button className="accordion-button pb-2 px-1" type="button" data-bs-toggle="collapse" data-bs-target="#collapseOne" aria-expanded="false" aria-controls="collapseOne">
                                                    <Icons iconName="regulation_year" className="me-2 icon-20 icon-filter" />On Date
                                                </button>
                                            </div>
                                                        ...
                                                        <div className='col-md-12 form-group'>
                                                            <div>
                                                                <DateCalendar
                                                                    value={date}
                                                                    format={dateFormat}
                                                                    onChange={(selectedDate) => { loadDateFilter(selectedDate, "on"); setDate(selectedDate) }}
                                                                />
                                                            </div>
                                                        </div>
                                                    </div>
                                        ...
                                        <div className="accordion-item mt-2 border border-0">
                                            <div className="accordion-header">
                                                <button className="accordion-button pb-2 px-1" type="button" data-bs-toggle="collapse" data-bs-target="#collapseTwo" aria-expanded="false" aria-controls="collapseTwo">
                                                    <Icons iconName="entity" className="me-2 icon-20 icon-filter" />Entity
                                                </button>
                                            </div>
                                                            ...
                                                            (entities.map((name, index) => (
                                                                <div key={index} className='col-md-12'>
                                                                    <CheckBox
                                                                        ...
                                                                        labelText={name}
                                                                        id={name}
                                                                        onChange={(e) => loadFilterOption(e, name, "entity")}
                                                                    />
                                                                </div>
                                                            ))) : ""}
                                                    </div>
                                        ...
                                        <div className="accordion-item mt-2 border border-0">
                                            <div className="accordion-header">
                                                <button className="accordion-button pb-2 px-1" type="button" data-bs-toggle="collapse" data-bs-target="#collapseThree" aria-expanded="false" aria-controls="collapseThree">
                                                    <Icons iconName="filter_action" className="me-2 icon-20 icon-filter" />Action
                                                </button>
                                            </div>
                                                            ...
                                                            (actions.map((status, index) => (
                                                                <div key={index} className='col-md-4 form-group'>
                                                                    <CheckBox
                                                                        ...
                                                                        labelText={status}
                                                                        id={status}
                                                                        onChange={(e) => loadFilterOption(e, status, "action")}
                                                                    />
                                                                </div>
                                                            ))) : ""}
                                                    </div>
